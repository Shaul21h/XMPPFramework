...
s.homepage = 'https://github.com/calibraint/XMPPFramework'
s.author = { 'Robbie Hanson' => 'robbiehanson@deusty.com' }
s.source = { :git => 'https://github.com/calibraint/XMPPFramework.git', :tag => s.version }
...
s.subspec 'Core' do |core|
  ...
  core.dependency 'KissXML/libxml_module', :git => "https://github.com/calibraint/KissXML.git"
end
